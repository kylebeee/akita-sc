...
export type NfdRegistryReturns = {
  ...
  'gas()void': void
  'getPrice(string,address)(uint64,uint64,bool,bool,bool)': [bigint, bigint, boolean, boolean, boolean]
  'getConstraints()(uint64,uint64,uint64,address,uint64,uint64,uint64)': [bigint, bigint, bigint, string, bigint, bigint, bigint]
  'getNfdMbrCost(string)uint64': bigint
  'getNfdLinkOnMintExtraMbrCost(address)(uint64,uint64)': [bigint, bigint]
