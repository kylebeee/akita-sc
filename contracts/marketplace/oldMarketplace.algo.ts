...
export class Marketplace extends ContractWithOptIn {
    ...
    list(
        ...
        const optinMBR = isAlgoPayment ? globals.assetOptInMinBalance : globals.assetOptInMinBalance * 2
    ...
    purchase(payment: PayTxn, appID: AppID, marketplace: Address, args: bytes[]): void {
    ...
    purchaseAsa(assetXfer: AssetTransferTxn, appID: AppID, marketplace: Address, args: bytes[]): void {
        assert(appID.creator === this.app.address, errs.NOT_A_LISTING)
