...
export class MarketplacePlugin extends Contract {
    ...
    list(
        ...
        const optinMBR = paymentAsset.id === 0 ? globals.assetOptInMinBalance : globals.assetOptInMinBalance * 2

        const childContractMBR =
            100_000 + 28_500 * Listing.schema.global.numUint + 50_000 * Listing.schema.global.numByteSlice + optinMBR
