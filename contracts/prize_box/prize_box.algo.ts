...
import { Address, DynamicArray } from '@algorandfoundation/algorand-typescript/arc4'
...
export class PrizeBox extends Contract {
     ...
     */
    optin(payment: PaymentTxn, asset: uint64): void {
    ...
    withdraw(assets: DynamicArray<arc4AssetInfo>): void {
        assert(Txn.sender === this.owner.value, ERR_NOT_OWNER)
