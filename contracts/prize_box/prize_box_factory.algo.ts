...
export class PrizeBoxFactory extends FactoryContract {
    ...
    mint(payment: PaymentTxn, owner: Address): uint64 {
        assert(payment.receiver === Global.currentApplicationAddress, ERR_INVALID_PAYMENT_RECEIVER)

        const prizeBox = compile(PrizeBox)

        assert(
            payment.amount === 100_000 + 28_500 * prizeBox.globalBytes + 50_000 * prizeBox.globalUints,
        ...
        return itxn
            .applicationCall({
                ...
                appArgs: [methodSelector(PrizeBox.prototype.createApplication), owner],
