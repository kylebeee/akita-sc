import { Account, Application, arc4, assert, BoxMap, Bytes, Contract, GlobalState, op, uint64 } from "@algorandfoundation/algorand-typescript";
...
export class ServiceFactoryContract extends FactoryContract {
    ...
    appCreators = BoxMap<arc4AppCreatorKey, arc4.UintN64>({ keyPrefix: '' })
    ...
    protected getPrizeBoxOwner(prizeBox: Application): Account {
        ...
        return decodeArc4<Account>(ownerBytes)
    }
}