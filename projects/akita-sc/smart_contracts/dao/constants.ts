...
export const AkitaDAOGlobalStateKeysAkitaAppList = 'akita-al'
export const AkitaDAOGlobalStateKeysPluginAppList = 'plugn-al'
export const AkitaDAOGlobalStateKeysOtherAppList = 'other-al'
