...
import { DAOPluginSDK, newWallet, WalletSDK } from 'akita-sdk/wallet';
...
describe('DAO plugin contract', () => {
  ...
  beforeAll(async () => {
    ...
    daoPluginSdk = akitaUniverse.daoPlugin;
    ...
    await wallet.addPlugin({ client: daoPluginSdk, global: true });
  });

  beforeEach(fixture.newScope);

  describe('DAOPlugin SDK', () => {
    test('plugin can be added to wallet', async () => {
      ...
      expect(daoPluginSdk.appId).toBeGreaterThan(0n);
    });
  });
});
