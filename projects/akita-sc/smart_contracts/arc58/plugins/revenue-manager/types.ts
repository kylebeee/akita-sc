...
/**
 * Reference to splits stored in another contract's global state
 * Used to dynamically pull split configuration from an external source
 */
export type SplitRef = {
  /** app id of the contract containing the splits */
  app: uint64
  /** global state key where the Split[] is stored */
  key: bytes
}
