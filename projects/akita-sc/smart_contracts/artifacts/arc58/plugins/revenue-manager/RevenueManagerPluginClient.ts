...
export type RevenueManagerPluginArgs = {
  ...
  obj: {
    ...
    'newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void': {
      wallet: bigint | number
      rekeyBack: boolean
      escrow: string
      source: string
      allocatable: boolean
      optinAllowed: boolean
      splits: [string, bigint | number, bigint | number][]
    }
  ...
  tuple: {
    ...
    'newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void': [wallet: bigint | number, rekeyBack: boolean, escrow: string, source: string, allocatable: boolean, optinAllowed: boolean, splits: [string, bigint | number, bigint | number][]]
...
export type RevenueManagerPluginReturns = {
  ...
  'newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void': void
...
export type RevenueManagerPluginTypes = {
  ...
  methods:
    ...
    & Record<'newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void' | 'newReceiveEscrow', {
      argsObj: RevenueManagerPluginArgs['obj']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void']
      argsTuple: RevenueManagerPluginArgs['tuple']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void']
      returns: RevenueManagerPluginReturns['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void']
    }>
  ...
  state: {
    ...
    box: {
      ...
      maps: {
         ...
         */
        splits: Map<WalletEscrowKey, [string, number, bigint][]>
        /**
...
export abstract class RevenueManagerPluginParamsFactory {
  ...
  * optin exists because revenue manager uses additional metadata to track optin counts for processing payments
  ...
  /**
   * Constructs a no op call for the newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void ABI method
   *
  * Creates a new receive escrow with direct splits
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static newReceiveEscrow(params: CallParams<RevenueManagerPluginArgs['obj']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void'] | RevenueManagerPluginArgs['tuple']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void' as const,
...
export class RevenueManagerPluginClient {
  ...
  readonly params = {
    ...
    * optin exists because revenue manager uses additional metadata to track optin counts for processing payments
    ...
    /**
     * Makes a call to the RevenueManagerPlugin smart contract using the `newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void` ABI method.
     *
    * Creates a new receive escrow with direct splits
    Use this when you want to store splits directly in this contract
     ...
     * @returns The call params
     */
    newReceiveEscrow: (params: CallParams<RevenueManagerPluginArgs['obj']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void'] | RevenueManagerPluginArgs['tuple']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
    ...
    * Creates a new receive escrow with direct splits
     ...
     * @returns The call result
     */
    newReceiveEscrow: async (params: CallParams<RevenueManagerPluginArgs['obj']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void'] | RevenueManagerPluginArgs['tuple']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(RevenueManagerPluginParamsFactory.newReceiveEscrow(params))
      return {...result, return: result.return as unknown as (undefined | RevenueManagerPluginReturns['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void'])}
    },
  ...
  state = {
    ...
    box: {
      ...
      splits: {
         ...
         */
        getMap: async (): Promise<Map<WalletEscrowKey, [string, number, bigint][]>> => { return (await this.appClient.state.box.getMap("splits")) as Map<WalletEscrowKey, [string, number, bigint][]> },
        /**
         * Get a current value of the splits map by key from box state
         */
        value: async (key: WalletEscrowKey): Promise<[string, number, bigint][] | undefined> => { return await this.appClient.state.box.getMapValue("splits", key) as [string, number, bigint][] | undefined },
      },
      /**
  ...
  public newGroup(): RevenueManagerPluginComposer {
    ...
    return {
      ...
      /**
       * Add a newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void method call against the RevenueManagerPlugin contract
       */
      newReceiveEscrow(params: CallParams<RevenueManagerPluginArgs['obj']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void'] | RevenueManagerPluginArgs['tuple']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
...
export type RevenueManagerPluginComposer<TReturns extends [...any[]] = []> = {
  ...
  * optin exists because revenue manager uses additional metadata to track optin counts for processing payments
  ...
  /**
   * Calls the newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void ABI method.
   *
  * Creates a new receive escrow with direct splits
  Use this when you want to store splits directly in this contract
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  newReceiveEscrow(params?: CallParams<RevenueManagerPluginArgs['obj']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void'] | RevenueManagerPluginArgs['tuple']['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void']>): RevenueManagerPluginComposer<[...TReturns, RevenueManagerPluginReturns['newReceiveEscrow(uint64,bool,string,address,bool,bool,(address,uint8,uint64)[])void'] | undefined]>
