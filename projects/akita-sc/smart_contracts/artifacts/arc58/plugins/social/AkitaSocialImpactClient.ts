...
export type AkitaSocialImpactTypes = {
  ...
  methods:
    & Record<'createApplication(uint64,string)void' | 'createApplication', {
      argsObj: AkitaSocialImpactArgs['obj']['createApplication(uint64,string)void']
      argsTuple: AkitaSocialImpactArgs['tuple']['createApplication(uint64,string)void']
      returns: AkitaSocialImpactReturns['createApplication(uint64,string)void']
    }>
    ...
    & Record<'updateApplication(string)void' | 'updateApplication', {
      argsObj: AkitaSocialImpactArgs['obj']['updateApplication(string)void']
      argsTuple: AkitaSocialImpactArgs['tuple']['updateApplication(string)void']
      returns: AkitaSocialImpactReturns['updateApplication(string)void']
    }>
...
export type AkitaSocialImpactCreateCallParams =
  | Expand<CallParams<AkitaSocialImpactArgs['obj']['createApplication(uint64,string)void'] | AkitaSocialImpactArgs['tuple']['createApplication(uint64,string)void']> & {method: 'createApplication'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
  | Expand<CallParams<AkitaSocialImpactArgs['obj']['createApplication(uint64,string)void'] | AkitaSocialImpactArgs['tuple']['createApplication(uint64,string)void']> & {method: 'createApplication(uint64,string)void'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
/**
 * Defines supported update method params for this smart contract
 */
export type AkitaSocialImpactUpdateCallParams =
  | Expand<CallParams<AkitaSocialImpactArgs['obj']['updateApplication(string)void'] | AkitaSocialImpactArgs['tuple']['updateApplication(string)void']> & {method: 'updateApplication'}>
  | Expand<CallParams<AkitaSocialImpactArgs['obj']['updateApplication(string)void'] | AkitaSocialImpactArgs['tuple']['updateApplication(string)void']> & {method: 'updateApplication(string)void'}>
/**
...
export abstract class AkitaSocialImpactParamsFactory {
  ...
  static get create() {
    return {
      ...
      /**
       * Constructs create ABI call params for the AkitaSocialImpact smart contract using the createApplication(uint64,string)void ABI method
       *
       * @param params Parameters for the call
       * @returns An `AppClientMethodCallParams` object for the call
       */
      createApplication(params: CallParams<AkitaSocialImpactArgs['obj']['createApplication(uint64,string)void'] | AkitaSocialImpactArgs['tuple']['createApplication(uint64,string)void']> & AppClientCompilationParams & {onComplete?: OnApplicationComplete.NoOpOC}): AppClientMethodCallParams & AppClientCompilationParams & {onComplete?: OnApplicationComplete.NoOpOC} {
        return {
          ...params,
      ...
      _resolveByMethod<TParams extends AkitaSocialImpactUpdateCallParams & {method: string}>(params: TParams) {
        switch(params.method) {
          ...
          case 'updateApplication(string)void':
            return AkitaSocialImpactParamsFactory.update.updateApplication(params)
        }
        throw new Error(`Unknown ' + verb + ' method`)
      },

      /**
       * Constructs update ABI call params for the AkitaSocialImpact smart contract using the updateApplication(string)void ABI method
       *
       * @param params Parameters for the call
       * @returns An `AppClientMethodCallParams` object for the call
       */
      updateApplication(params: CallParams<AkitaSocialImpactArgs['obj']['updateApplication(string)void'] | AkitaSocialImpactArgs['tuple']['updateApplication(string)void']> & AppClientCompilationParams): AppClientMethodCallParams & AppClientCompilationParams {
        return {
          ...params,
...
export class AkitaSocialImpactFactory {
  ...
  readonly params = {
    ...
    create: {
      /**
       * Creates a new instance of the AkitaSocialImpact smart contract using the createApplication(uint64,string)void ABI method.
       *
       * @param params The params for the smart contract call
       * @returns The create params
       */
      createApplication: (params: CallParams<AkitaSocialImpactArgs['obj']['createApplication(uint64,string)void'] | AkitaSocialImpactArgs['tuple']['createApplication(uint64,string)void']> & AppClientCompilationParams & CreateSchema & {onComplete?: OnApplicationComplete.NoOpOC}) => {
    ...
    deployUpdate: {
      /**
       * Updates an existing instance of the AkitaSocialImpact smart contract using the updateApplication(string)void ABI method.
       *
       * @param params The params for the smart contract call
       * @returns The deployUpdate params
       */
      updateApplication: (params: CallParams<AkitaSocialImpactArgs['obj']['updateApplication(string)void'] | AkitaSocialImpactArgs['tuple']['updateApplication(string)void']> & AppClientCompilationParams) => {
        return this.appFactory.params.deployUpdate(AkitaSocialImpactParamsFactory.update.updateApplication(params))
      },
    },
  ...
  readonly send = {
    ...
    create: {
      /**
       * Creates a new instance of the AkitaSocialImpact smart contract using an ABI method call using the createApplication(uint64,string)void ABI method.
       *
       * @param params The params for the smart contract call
       * @returns The create result
       */
      createApplication: async (params: CallParams<AkitaSocialImpactArgs['obj']['createApplication(uint64,string)void'] | AkitaSocialImpactArgs['tuple']['createApplication(uint64,string)void']> & AppClientCompilationParams & CreateSchema & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
        const result = await this.appFactory.send.create(AkitaSocialImpactParamsFactory.create.createApplication(params))
        return { result: { ...result.result, return: result.result.return as unknown as (undefined | AkitaSocialImpactReturns['createApplication(uint64,string)void']) }, appClient: new AkitaSocialImpactClient(result.appClient) }
      },
    },
...
export class AkitaSocialImpactClient {
  ...
  readonly params = {
    ...
    update: {
       ...
       */
      updateApplication: (params: CallParams<AkitaSocialImpactArgs['obj']['updateApplication(string)void'] | AkitaSocialImpactArgs['tuple']['updateApplication(string)void']> & AppClientCompilationParams) => {
        return this.appClient.params.update(AkitaSocialImpactParamsFactory.update.updateApplication(params))
      },
  ...
  readonly createTransaction = {
    ...
    update: {
       ...
       */
      updateApplication: (params: CallParams<AkitaSocialImpactArgs['obj']['updateApplication(string)void'] | AkitaSocialImpactArgs['tuple']['updateApplication(string)void']> & AppClientCompilationParams) => {
        return this.appClient.createTransaction.update(AkitaSocialImpactParamsFactory.update.updateApplication(params))
      },
  ...
  readonly send = {
    ...
    update: {
       ...
       */
      updateApplication: async (params: CallParams<AkitaSocialImpactArgs['obj']['updateApplication(string)void'] | AkitaSocialImpactArgs['tuple']['updateApplication(string)void']> & AppClientCompilationParams & SendParams) => {
        const result = await this.appClient.send.update(AkitaSocialImpactParamsFactory.update.updateApplication(params))
        return {...result, return: result.return as unknown as (undefined | AkitaSocialImpactReturns['updateApplication(string)void'])}
      },
...
export type AkitaSocialImpactComposer<TReturns extends [...any[]] = []> = {
  ...
  readonly update: {
     ...
     * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
     */
    updateApplication(params?: CallParams<AkitaSocialImpactArgs['obj']['updateApplication(string)void'] | AkitaSocialImpactArgs['tuple']['updateApplication(string)void']>): AkitaSocialImpactComposer<[...TReturns, AkitaSocialImpactReturns['updateApplication(string)void'] | undefined]>
  }
