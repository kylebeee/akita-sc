...
export type AbstractedAccountTypes = {
   ...
   */
  methods:
    & Record<'create(string,uint64,address,address,string,uint64,uint64,string,address)void' | 'create', {
...
export type AbstractedAccountCreateCallParams =
  | Expand<CallParams<AbstractedAccountArgs['obj']['create(string,uint64,address,address,string,uint64,uint64,string,address)void'] | AbstractedAccountArgs['tuple']['create(string,uint64,address,address,string,uint64,uint64,string,address)void']> & {method: 'create'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
  | Expand<CallParams<AbstractedAccountArgs['obj']['create(string,uint64,address,address,string,uint64,uint64,string,address)void'] | AbstractedAccountArgs['tuple']['create(string,uint64,address,address,string,uint64,uint64,string,address)void']> & {method: 'create(string,uint64,address,address,string,uint64,uint64,string,address)void'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
/**
...
export abstract class AbstractedAccountParamsFactory {
  ...
  static get create() {
    return {
       ...
       */
      create(params: CallParams<AbstractedAccountArgs['obj']['create(string,uint64,address,address,string,uint64,uint64,string,address)void'] | AbstractedAccountArgs['tuple']['create(string,uint64,address,address,string,uint64,uint64,string,address)void']> & AppClientCompilationParams & {onComplete?: OnApplicationComplete.NoOpOC}): AppClientMethodCallParams & AppClientCompilationParams & {onComplete?: OnApplicationComplete.NoOpOC} {
        return {
          ...params,
          method: 'create(string,uint64,address,address,string,uint64,uint64,string,address)void' as const,
  ...
  readonly params = {
    ...
    create: {
      ...
      * Create an abstracted account application.
       ...
       */
      create: (params: CallParams<AbstractedAccountArgs['obj']['create(string,uint64,address,address,string,uint64,uint64,string,address)void'] | AbstractedAccountArgs['tuple']['create(string,uint64,address,address,string,uint64,uint64,string,address)void']> & AppClientCompilationParams & CreateSchema & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
    ...
    create: {
      ...
      * Create an abstracted account application.
       ...
       */
      create: async (params: CallParams<AbstractedAccountArgs['obj']['create(string,uint64,address,address,string,uint64,uint64,string,address)void'] | AbstractedAccountArgs['tuple']['create(string,uint64,address,address,string,uint64,uint64,string,address)void']> & AppClientCompilationParams & CreateSchema & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
        const result = await this.appFactory.send.create(AbstractedAccountParamsFactory.create.create(params))
        return { result: { ...result.result, return: result.result.return as unknown as (undefined | AbstractedAccountReturns['create(string,uint64,address,address,string,uint64,uint64,string,address)void']) }, appClient: new AbstractedAccountClient(result.appClient) }
      },
    },
