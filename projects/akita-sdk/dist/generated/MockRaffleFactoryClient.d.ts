 ...
 */
export type MockRaffleFactoryCreateCallParams = Expand<AppClientBareCallParams & {
    method?: never;
} & {
 ...
 */
export type MockRaffleFactoryDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
    /**
     * Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)
     */
    createParams?: MockRaffleFactoryCreateCallParams;
}>;
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the MockRaffleFactory smart contract
 */
export declare abstract class MockRaffleFactoryParamsFactory {
    /**
 ...
 */
export declare class MockRaffleFactoryFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): MockRaffleFactoryClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<MockRaffleFactoryClient>;
    /**
     ...
     */
    deploy(params?: MockRaffleFactoryDeployParams): Promise<{
        result: {
        ...
        appClient: MockRaffleFactoryClient;
    }>;
    /**
 ...
 */
export declare class MockRaffleFactoryClient {
    /**
     ...
     */
    decodeReturnValue<TSignature extends MockRaffleFactoryNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined): MethodReturn<TSignature> | undefined;
    /**
     * Returns a new `MockRaffleFactoryClient` client, resolving the app by creator address and name
     * using AlgoKit app deployment semantics (i.e. looking for the app creation transaction note).
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<MockRaffleFactoryClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<MockRaffleFactoryClient>;
    ...
    readonly params: {
         ...
         */
        ping: (params?: CallParams<MockRaffleFactoryArgs["obj"]["ping()uint64"] | MockRaffleFactoryArgs["tuple"]["ping()uint64"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
    ...
    readonly send: {
         ...
         */
        ping: (params?: CallParams<MockRaffleFactoryArgs["obj"]["ping()uint64"] | MockRaffleFactoryArgs["tuple"]["ping()uint64"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | MockRaffleFactoryReturns["ping()uint64"]);
            groupId: string;
            txIds: string[];
     ...
     */
    clone(params: CloneAppClientParams): MockRaffleFactoryClient;
    /**
     * Methods to access state for the current MockRaffleFactory app
     */
    state: {};
    newGroup(): MockRaffleFactoryComposer;
}
export type MockRaffleFactoryComposer<TReturns extends [...any[]] = []> = {
     ...
     */
    simulate(): Promise<MockRaffleFactoryComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<MockRaffleFactoryComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<MockRaffleFactoryComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    /**
