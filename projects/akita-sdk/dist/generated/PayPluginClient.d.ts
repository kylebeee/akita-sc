...
export type PayPluginTypes = {
     ...
     */
    methods: Record<'pay(uint64,bool,(address,uint64,uint64)[])void' | 'pay', {
 ...
 */
export type PayPluginCreateCallParams = Expand<AppClientBareCallParams & {
    method?: never;
} & {
 ...
 */
export declare abstract class PayPluginParamsFactory {
    /**
 ...
 */
export declare class PayPluginFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): PayPluginClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<PayPluginClient>;
    /**
     ...
     */
    deploy(params?: PayPluginDeployParams): Promise<{
        result: {
 ...
 */
export declare class PayPluginClient {
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<PayPluginClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<PayPluginClient>;
    ...
    readonly params: {
         ...
         */
        pay: (params: CallParams<PayPluginArgs["obj"]["pay(uint64,bool,(address,uint64,uint64)[])void"] | PayPluginArgs["tuple"]["pay(uint64,bool,(address,uint64,uint64)[])void"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
    ...
    readonly send: {
         ...
         */
        pay: (params: CallParams<PayPluginArgs["obj"]["pay(uint64,bool,(address,uint64,uint64)[])void"] | PayPluginArgs["tuple"]["pay(uint64,bool,(address,uint64,uint64)[])void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | PayPluginReturns["pay(uint64,bool,(address,uint64,uint64)[])void"]);
            groupId: string;
            txIds: string[];
     ...
     */
    clone(params: CloneAppClientParams): PayPluginClient;
    /**
     * Methods to access state for the current PayPlugin app
     */
    state: {};
    newGroup(): PayPluginComposer;
}
export type PayPluginComposer<TReturns extends [...any[]] = []> = {
     ...
     */
    simulate(): Promise<PayPluginComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<PayPluginComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<PayPluginComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    /**
