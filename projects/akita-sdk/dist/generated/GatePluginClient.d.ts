 ...
 */
export type GatePluginCreateCallParams = Expand<CallParams<GatePluginArgs['obj']['create(uint64)void'] | GatePluginArgs['tuple']['create(uint64)void']> & {
    method: 'create';
} & {
    onComplete?: OnApplicationComplete.NoOpOC;
} & CreateSchema> | Expand<CallParams<GatePluginArgs['obj']['create(uint64)void'] | GatePluginArgs['tuple']['create(uint64)void']> & {
 ...
 */
export declare abstract class GatePluginParamsFactory {
    /**
     * Gets available create ABI call param factories
     */
    static get create(): {
        _resolveByMethod<TParams extends GatePluginCreateCallParams & {
            method: string;
        }>(params: TParams): {
         ...
         */
        create(params: CallParams<GatePluginArgs["obj"]["create(uint64)void"] | GatePluginArgs["tuple"]["create(uint64)void"]> & AppClientCompilationParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
 ...
 */
export declare class GatePluginFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): GatePluginClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<GatePluginClient>;
    /**
     ...
     */
    deploy(params?: GatePluginDeployParams): Promise<{
        result: {
    ...
    readonly params: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<GatePluginArgs["obj"]["create(uint64)void"] | GatePluginArgs["tuple"]["create(uint64)void"]> & AppClientCompilationParams & CreateSchema & {
                onComplete?: OnApplicationComplete.NoOpOC;
            }) => Promise<{
    ...
    readonly send: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<GatePluginArgs["obj"]["create(uint64)void"] | GatePluginArgs["tuple"]["create(uint64)void"]> & AppClientCompilationParams & CreateSchema & SendParams & {
                onComplete?: OnApplicationComplete.NoOpOC;
            }) => Promise<{
                result: {
                    return: (undefined | GatePluginReturns["create(uint64)void"]);
                    compiledApproval?: import("@algorandfoundation/algokit-utils/types/app").CompiledTeal | undefined;
                    compiledClear?: import("@algorandfoundation/algokit-utils/types/app").CompiledTeal | undefined;
                    appId: bigint;
                    groupId: string;
 ...
 */
export declare class GatePluginClient {
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<GatePluginClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<GatePluginClient>;
    ...
    readonly params: {
         ...
         */
        register: (params: CallParams<GatePluginArgs["obj"]["register(uint64,bool,(uint64,uint64,uint8)[],byte[][])void"] | GatePluginArgs["tuple"]["register(uint64,bool,(uint64,uint64,uint8)[],byte[][])void"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
    ...
    readonly send: {
         ...
         */
        register: (params: CallParams<GatePluginArgs["obj"]["register(uint64,bool,(uint64,uint64,uint8)[],byte[][])void"] | GatePluginArgs["tuple"]["register(uint64,bool,(uint64,uint64,uint8)[],byte[][])void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | GatePluginReturns["register(uint64,bool,(uint64,uint64,uint8)[],byte[][])void"]);
            groupId: string;
            txIds: string[];
     ...
     */
    clone(params: CloneAppClientParams): GatePluginClient;
    /**
    ...
    state: {
        ...
        global: {
             ...
             */
            gateAppId: () => Promise<bigint | undefined>;
        };
    };
    newGroup(): GatePluginComposer;
}
export type GatePluginComposer<TReturns extends [...any[]] = []> = {
     ...
     */
    simulate(): Promise<GatePluginComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<GatePluginComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<GatePluginComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    /**
