...
exports.SubscriptionGateClient = exports.SubscriptionGateFactory = exports.SubscriptionGateParamsFactory = exports.APP_SPEC = void 0;
exports.SubscriptionGateRegistryInfoFromTuple = SubscriptionGateRegistryInfoFromTuple;
 ...
 */
function SubscriptionGateRegistryInfoFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.SubscriptionGateRegistryInfo, exports.APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the SubscriptionGate smart contract
 */
class SubscriptionGateParamsFactory {
    /**
...
exports.SubscriptionGateParamsFactory = SubscriptionGateParamsFactory;
/**
...
exports.SubscriptionGateFactory = SubscriptionGateFactory;
/**
...
class SubscriptionGateClient {
    ...
    static async fromCreatorAndName(params) {
        return new SubscriptionGateClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new SubscriptionGateClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.SubscriptionGateClient = SubscriptionGateClient;
