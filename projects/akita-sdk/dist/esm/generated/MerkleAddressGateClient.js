 ...
 */
export function MerkleAddressGateRegistryInfoFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.MerkleAddressGateRegistryInfo, APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the MerkleAddressGate smart contract
 */
export class MerkleAddressGateParamsFactory {
    /**
