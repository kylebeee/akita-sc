...
exports.AsaMintPluginClient = exports.AsaMintPluginFactory = exports.AsaMintPluginParamsFactory = exports.APP_SPEC = void 0;
 ...
 */
class AsaMintPluginParamsFactory {
    /**
...
exports.AsaMintPluginParamsFactory = AsaMintPluginParamsFactory;
/**
...
exports.AsaMintPluginFactory = AsaMintPluginFactory;
/**
 * A client to make calls to the AsaMintPlugin smart contract
 */
class AsaMintPluginClient {
    ...
    static async fromCreatorAndName(params) {
        return new AsaMintPluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new AsaMintPluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.AsaMintPluginClient = AsaMintPluginClient;
