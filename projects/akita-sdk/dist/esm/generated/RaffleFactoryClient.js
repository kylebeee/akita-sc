 ...
 */
export function RaffleMbrDataFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.RaffleMBRData, APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the RaffleFactory smart contract
 */
export class RaffleFactoryParamsFactory {
    /**
