...
exports.HyperSwapPluginClient = exports.HyperSwapPluginFactory = exports.HyperSwapPluginParamsFactory = exports.APP_SPEC = void 0;
 ...
 */
class HyperSwapPluginParamsFactory {
    /**
...
exports.HyperSwapPluginParamsFactory = HyperSwapPluginParamsFactory;
/**
...
exports.HyperSwapPluginFactory = HyperSwapPluginFactory;
/**
 * A client to make calls to the HyperSwapPlugin smart contract
 */
class HyperSwapPluginClient {
    ...
    static async fromCreatorAndName(params) {
        return new HyperSwapPluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new HyperSwapPluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.HyperSwapPluginClient = HyperSwapPluginClient;
