...
exports.GateClient = exports.GateFactory = exports.GateParamsFactory = exports.APP_SPEC = void 0;
exports.GateFilterEntryWithArgsFromTuple = GateFilterEntryWithArgsFromTuple;
 ...
 */
function GateFilterEntryWithArgsFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.GateFilterEntryWithArgs, exports.APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the Gate smart contract
 */
class GateParamsFactory {
    /**
...
exports.GateParamsFactory = GateParamsFactory;
/**
...
class GateClient {
    ...
    static async fromCreatorAndName(params) {
        return new GateClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new GateClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
