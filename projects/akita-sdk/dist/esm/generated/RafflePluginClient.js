...
exports.RafflePluginClient = exports.RafflePluginFactory = exports.RafflePluginParamsFactory = exports.APP_SPEC = void 0;
 ...
 */
class RafflePluginParamsFactory {
    /**
...
exports.RafflePluginParamsFactory = RafflePluginParamsFactory;
/**
...
class RafflePluginFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? RafflePluginParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
        return { result: result.result, appClient: new RafflePluginClient(result.appClient) };
    }
}
exports.RafflePluginFactory = RafflePluginFactory;
/**
...
class RafflePluginClient {
    ...
    static async fromCreatorAndName(params) {
        return new RafflePluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new RafflePluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.RafflePluginClient = RafflePluginClient;
//# sourceMappingURL=RafflePluginClient.js.map