...
exports.PrizeBoxFactoryClient = exports.PrizeBoxFactoryFactory = exports.PrizeBoxFactoryParamsFactory = exports.APP_SPEC = void 0;
 ...
 */
class PrizeBoxFactoryParamsFactory {
    /**
...
exports.PrizeBoxFactoryParamsFactory = PrizeBoxFactoryParamsFactory;
/**
...
class PrizeBoxFactoryFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? PrizeBoxFactoryParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
            updateParams: params.updateParams?.method ? PrizeBoxFactoryParamsFactory.update._resolveByMethod(params.updateParams) : params.updateParams ? params.updateParams : undefined,
        });
        return { result: result.result, appClient: new PrizeBoxFactoryClient(result.appClient) };
    }
}
exports.PrizeBoxFactoryFactory = PrizeBoxFactoryFactory;
/**
...
class PrizeBoxFactoryClient {
    ...
    static async fromCreatorAndName(params) {
        return new PrizeBoxFactoryClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new PrizeBoxFactoryClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.PrizeBoxFactoryClient = PrizeBoxFactoryClient;
//# sourceMappingURL=PrizeBoxFactoryClient.js.map