...
exports.PrizeBoxClient = exports.PrizeBoxFactory = exports.PrizeBoxParamsFactory = exports.APP_SPEC = void 0;
...
exports.PrizeBoxParamsFactory = PrizeBoxParamsFactory;
/**
...
class PrizeBoxFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? PrizeBoxParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
            deleteParams: params.deleteParams?.method ? PrizeBoxParamsFactory.delete._resolveByMethod(params.deleteParams) : params.deleteParams ? params.deleteParams : undefined,
        });
        return { result: result.result, appClient: new PrizeBoxClient(result.appClient) };
    }
}
exports.PrizeBoxFactory = PrizeBoxFactory;
/**
...
class PrizeBoxClient {
    constructor(appClientOrParams) {
        ...
        this.state = {
            ...
            global: {
                 ...
                 */
                owner: async () => { return (await this.appClient.state.global.getValue("owner")); },
                /**
                 * Get the current value of the optinCount key in global state
                 */
                optinCount: async () => { return (await this.appClient.state.global.getValue("optinCount")); },
            },
        };
    ...
    static async fromCreatorAndName(params) {
        return new PrizeBoxClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new PrizeBoxClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.PrizeBoxClient = PrizeBoxClient;
//# sourceMappingURL=PrizeBoxClient.js.map