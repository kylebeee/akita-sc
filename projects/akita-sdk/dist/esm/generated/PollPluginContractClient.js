...
exports.PollPluginContractClient = exports.PollPluginContractFactory = exports.PollPluginContractParamsFactory = exports.APP_SPEC = void 0;
 ...
 */
class PollPluginContractParamsFactory {
    /**
...
exports.PollPluginContractParamsFactory = PollPluginContractParamsFactory;
/**
 ...
 */
class PollPluginContractFactory {
    /**
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? PollPluginContractParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
        return { result: result.result, appClient: new PollPluginContractClient(result.appClient) };
    }
}
exports.PollPluginContractFactory = PollPluginContractFactory;
/**
...
class PollPluginContractClient {
    ...
    static async fromCreatorAndName(params) {
        return new PollPluginContractClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new PollPluginContractClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.PollPluginContractClient = PollPluginContractClient;
//# sourceMappingURL=PollPluginContractClient.js.map