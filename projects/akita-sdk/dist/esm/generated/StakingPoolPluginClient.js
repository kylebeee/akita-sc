 ...
 */
export function RaffleCursorFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.RaffleCursor, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a Reward to the struct representation
 */
export function RewardFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.Reward, APP_SPEC.structs);
}
/**
 ...
 */
export class StakingPoolPluginParamsFactory {
    /**
