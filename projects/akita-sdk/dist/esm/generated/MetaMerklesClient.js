 ...
 */
export function DataKeyFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.DataKey, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a RootKey to the struct representation
 */
export function RootKeyFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.RootKey, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a TypesValue to the struct representation
 */
export function TypesValueFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.TypesValue, APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the MetaMerkles smart contract
 */
export class MetaMerklesParamsFactory {
    /**
