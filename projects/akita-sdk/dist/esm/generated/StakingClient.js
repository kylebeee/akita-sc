 ...
 */
export function EscrowFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.Escrow, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a HeartbeatKey to the struct representation
 */
export function HeartbeatKeyFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.HeartbeatKey, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a Stake to the struct representation
 */
export function StakeFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.Stake, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a StakeCheck to the struct representation
 */
export function StakeCheckFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.StakeCheck, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a StakeInfo to the struct representation
 */
export function StakeInfoFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.StakeInfo, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a StakeKey to the struct representation
 */
export function StakeKeyFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.StakeKey, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a TotalsInfo to the struct representation
 */
export function TotalsInfoFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.TotalsInfo, APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the Staking smart contract
 */
export class StakingParamsFactory {
    /**
