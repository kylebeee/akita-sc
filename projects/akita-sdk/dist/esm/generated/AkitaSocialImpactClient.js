 ...
 */
export function Arc4ImpactMetaValueFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.arc4ImpactMetaValue, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a MetaValue to the struct representation
 */
export function MetaValueFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.MetaValue, APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the AkitaSocialImpact smart contract
 */
export class AkitaSocialImpactParamsFactory {
    /**
