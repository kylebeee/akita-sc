...
exports.NfdPluginClient = exports.NfdPluginFactory = exports.NfdPluginParamsFactory = exports.APP_SPEC = void 0;
...
exports.NfdPluginParamsFactory = NfdPluginParamsFactory;
/**
...
class NfdPluginFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? NfdPluginParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
        return { result: result.result, appClient: new NfdPluginClient(result.appClient) };
    }
}
exports.NfdPluginFactory = NfdPluginFactory;
/**
...
class NfdPluginClient {
    ...
    static async fromCreatorAndName(params) {
        return new NfdPluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new NfdPluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.NfdPluginClient = NfdPluginClient;
//# sourceMappingURL=NFDPluginClient.js.map