 ...
 */
export function AkitaReferrerGateRegistryInfoFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.AkitaReferrerGateRegistryInfo, APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the AkitaReferrerGate smart contract
 */
export class AkitaReferrerGateParamsFactory {
    /**
