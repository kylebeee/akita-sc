 ...
 */
export type OptInPluginCreateCallParams = Expand<AppClientBareCallParams & {
    method?: never;
} & {
 ...
 */
export declare class OptInPluginFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): OptInPluginClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<OptInPluginClient>;
    /**
     ...
     */
    deploy(params?: OptInPluginDeployParams): Promise<{
        result: {
 ...
 */
export declare class OptInPluginClient {
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<OptInPluginClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<OptInPluginClient>;
    ...
    readonly params: {
         ...
         */
        optIn: (params: CallParams<OptInPluginArgs["obj"]["optIn(uint64,bool,uint64[],pay)void"] | OptInPluginArgs["tuple"]["optIn(uint64,bool,uint64[],pay)void"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
    ...
    readonly send: {
         ...
         */
        optIn: (params: CallParams<OptInPluginArgs["obj"]["optIn(uint64,bool,uint64[],pay)void"] | OptInPluginArgs["tuple"]["optIn(uint64,bool,uint64[],pay)void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | OptInPluginReturns["optIn(uint64,bool,uint64[],pay)void"]);
            groupId: string;
            txIds: string[];
     ...
     */
    clone(params: CloneAppClientParams): OptInPluginClient;
    /**
     * Methods to access state for the current OptInPlugin app
     */
    state: {};
    newGroup(): OptInPluginComposer;
}
export type OptInPluginComposer<TReturns extends [...any[]] = []> = {
     ...
     */
    simulate(): Promise<OptInPluginComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<OptInPluginComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<OptInPluginComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    /**
