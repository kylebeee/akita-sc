 ...
 */
export type MockStakingPoolFactoryCreateCallParams = Expand<AppClientBareCallParams & {
    method?: never;
} & {
 ...
 */
export type MockStakingPoolFactoryDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
    /**
     * Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)
     */
    createParams?: MockStakingPoolFactoryCreateCallParams;
}>;
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the MockStakingPoolFactory smart contract
 */
export declare abstract class MockStakingPoolFactoryParamsFactory {
    /**
 ...
 */
export declare class MockStakingPoolFactoryFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): MockStakingPoolFactoryClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<MockStakingPoolFactoryClient>;
    /**
     ...
     */
    deploy(params?: MockStakingPoolFactoryDeployParams): Promise<{
        result: {
        ...
        appClient: MockStakingPoolFactoryClient;
    }>;
    /**
 ...
 */
export declare class MockStakingPoolFactoryClient {
    /**
     ...
     */
    decodeReturnValue<TSignature extends MockStakingPoolFactoryNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined): MethodReturn<TSignature> | undefined;
    /**
     * Returns a new `MockStakingPoolFactoryClient` client, resolving the app by creator address and name
     * using AlgoKit app deployment semantics (i.e. looking for the app creation transaction note).
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<MockStakingPoolFactoryClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<MockStakingPoolFactoryClient>;
    ...
    readonly params: {
         ...
         */
        ping: (params?: CallParams<MockStakingPoolFactoryArgs["obj"]["ping()uint64"] | MockStakingPoolFactoryArgs["tuple"]["ping()uint64"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
    ...
    readonly send: {
         ...
         */
        ping: (params?: CallParams<MockStakingPoolFactoryArgs["obj"]["ping()uint64"] | MockStakingPoolFactoryArgs["tuple"]["ping()uint64"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | MockStakingPoolFactoryReturns["ping()uint64"]);
            groupId: string;
            txIds: string[];
     ...
     */
    clone(params: CloneAppClientParams): MockStakingPoolFactoryClient;
    /**
     * Methods to access state for the current MockStakingPoolFactory app
     */
    state: {};
    newGroup(): MockStakingPoolFactoryComposer;
}
export type MockStakingPoolFactoryComposer<TReturns extends [...any[]] = []> = {
     ...
     */
    simulate(): Promise<MockStakingPoolFactoryComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<MockStakingPoolFactoryComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<MockStakingPoolFactoryComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    /**
