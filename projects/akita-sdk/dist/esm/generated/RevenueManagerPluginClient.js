 ...
 */
export function EscrowAssetKeyFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.EscrowAssetKey, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a ReceiveEscrow to the struct representation
 */
export function ReceiveEscrowFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.ReceiveEscrow, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a SplitRef to the struct representation
 */
export function SplitRefFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.SplitRef, APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a WalletEscrowKey to the struct representation
 */
export function WalletEscrowKeyFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.WalletEscrowKey, APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the RevenueManagerPlugin smart contract
 */
export class RevenueManagerPluginParamsFactory {
    /**
