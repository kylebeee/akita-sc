...
exports.RevenueManagerPluginClient = exports.RevenueManagerPluginFactory = exports.RevenueManagerPluginParamsFactory = exports.APP_SPEC = void 0;
exports.EscrowAssetKeyFromTuple = EscrowAssetKeyFromTuple;
exports.ReceiveEscrowFromTuple = ReceiveEscrowFromTuple;
exports.SplitRefFromTuple = SplitRefFromTuple;
exports.WalletEscrowKeyFromTuple = WalletEscrowKeyFromTuple;
 ...
 */
function EscrowAssetKeyFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.EscrowAssetKey, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a ReceiveEscrow to the struct representation
 */
function ReceiveEscrowFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.ReceiveEscrow, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a SplitRef to the struct representation
 */
function SplitRefFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.SplitRef, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a WalletEscrowKey to the struct representation
 */
function WalletEscrowKeyFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.WalletEscrowKey, exports.APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the RevenueManagerPlugin smart contract
 */
class RevenueManagerPluginParamsFactory {
    /**
...
exports.RevenueManagerPluginParamsFactory = RevenueManagerPluginParamsFactory;
/**
 ...
 */
class RevenueManagerPluginFactory {
    /**
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? RevenueManagerPluginParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
        return { result: result.result, appClient: new RevenueManagerPluginClient(result.appClient) };
    }
}
exports.RevenueManagerPluginFactory = RevenueManagerPluginFactory;
/**
...
class RevenueManagerPluginClient {
        ...
        this.state = {
            ...
            box: {
                ...
                receiveAssets: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("receiveAssets")); },
                    /**
                     * Get a current value of the receiveAssets map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("receiveAssets", key); },
                },
                /**
                ...
                splits: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("splits")); },
                    /**
                     * Get a current value of the splits map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("splits", key); },
                },
                /**
                ...
                splitRefs: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("splitRefs")); },
                    /**
                     * Get a current value of the splitRefs map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("splitRefs", key); },
                },
            },
        };
    ...
    static async fromCreatorAndName(params) {
        return new RevenueManagerPluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new RevenueManagerPluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.RevenueManagerPluginClient = RevenueManagerPluginClient;
//# sourceMappingURL=RevenueManagerPluginClient.js.map