 ...
 */
export function StakingPowerGateRegistryInfoFromTuple(abiTuple) {
    return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.StakingPowerGateRegistryInfo, APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the StakingPowerGate smart contract
 */
export class StakingPowerGateParamsFactory {
    /**
