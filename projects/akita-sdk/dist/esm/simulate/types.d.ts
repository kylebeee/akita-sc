...
export type SimulateCallbacks = {
    sign?: (atc: algosdk.AtomicTransactionComposer) => Promise<algosdk.SignedTransaction[] | Uint8Array[]>;
    send?: (signedTxns: (algosdk.SignedTransaction | Uint8Array)[]) => Promise<string>;
};
/**
