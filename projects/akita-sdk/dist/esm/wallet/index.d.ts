...
export declare class WalletSDK extends BaseSDK<AbstractedAccountClient> {
    ...
    addPlugin<TClient extends SDKClient>({ sender, signer, name, client, caller, global, methods, escrow, admin, delegationType, lastValid, cooldown, useRounds, useExecutionKey, defaultToEscrow, allowances }: WalletAddPluginParams<TClient>): Promise<GroupReturn>;
    ...
    readonly build: {
        usePlugin: ({ firstValid, windowSize, consolidateFees, ...args }: BuildWalletUsePluginParams) => Promise<ExecutionBuildGroup>;
    };
