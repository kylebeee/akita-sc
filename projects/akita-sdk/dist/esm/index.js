...
export { ENV_VAR_NAMES, getNetworkFromEnv, getEnvVar, getAppIdFromEnv, getConfigFromEnv, detectNetworkFromClient, getAppIdForSDK, resolveAppId, resolveAppIdWithClient, getCurrentNetwork, setCurrentNetwork, 
// Network-specific app IDs
TESTNET_APP_IDS, MAINNET_APP_IDS, NETWORK_APP_IDS, getNetworkAppIds, } from './config';
