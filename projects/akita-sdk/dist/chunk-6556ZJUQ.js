...
var AkitaSocialImpactClient = (_class6 = class _AkitaSocialImpactClient {
   ...
   */
  decodeReturnValue(method, returnValue) {
    return returnValue !== void 0 ? _apparc56.getArc56ReturnValue.call(void 0, returnValue, this.appClient.getABIMethod(method), APP_SPEC3.structs) : void 0;
  }
  /**
...
var AkitaSocialModerationClient = (_class8 = class _AkitaSocialModerationClient {
   ...
   */
  decodeReturnValue(method, returnValue) {
    return returnValue !== void 0 ? _apparc56.getArc56ReturnValue.call(void 0, returnValue, this.appClient.getABIMethod(method), APP_SPEC4.structs) : void 0;
  }
  /**
...
var SocialSDK = (_class9 = class _SocialSDK {
  ...
  constructor({
    ...
    readerAccount = _chunkHY3H6JQIjs.DEFAULT_READER,
    sendParams = _chunkHY3H6JQIjs.DEFAULT_SEND_PARAMS,
    ipfsUrl = ""
    ...
    this.daoAppId = _nullishCoalesce(daoAppId, () => ( _chunkHY3H6JQIjs.getAppIdFromEnv.call(void 0, _chunkHY3H6JQIjs.ENV_VAR_NAMES.DAO_APP_ID)));
    ...
    const resolvedSocialAppId = _chunkHY3H6JQIjs.resolveAppIdWithClient.call(void 0, algorand, socialFactoryParams.appId, _chunkHY3H6JQIjs.ENV_VAR_NAMES.SOCIAL_APP_ID, "SocialSDK.social");
    const resolvedGraphAppId = _chunkHY3H6JQIjs.resolveAppIdWithClient.call(void 0, algorand, graphFactoryParams.appId, _chunkHY3H6JQIjs.ENV_VAR_NAMES.SOCIAL_GRAPH_APP_ID, "SocialSDK.graph");
    const resolvedImpactAppId = _chunkHY3H6JQIjs.resolveAppIdWithClient.call(void 0, algorand, impactFactoryParams.appId, _chunkHY3H6JQIjs.ENV_VAR_NAMES.SOCIAL_IMPACT_APP_ID, "SocialSDK.impact");
    const resolvedModerationAppId = _chunkHY3H6JQIjs.resolveAppIdWithClient.call(void 0, algorand, moderationFactoryParams.appId, _chunkHY3H6JQIjs.ENV_VAR_NAMES.SOCIAL_MODERATION_APP_ID, "SocialSDK.moderation");
    ...
    if (this.daoAppId !== void 0 && this.daoAppId > 0n) {
      this.daoClient = new (0, _chunkB2QFHBQDjs.AkitaDaoFactory)({ algorand }).getAppClientById({ appId: this.daoAppId });
    }
  ...
  computePostKey(creatorAddress, timestamp, nonce) {
    const { decodeAddress } = _chunkDGUM43GVjs.__require.call(void 0, "algosdk");
  ...
  static sha256Static(data) {
    if (typeof globalThis !== "undefined" && "crypto" in globalThis) {
      const { sha256 } = _chunkDGUM43GVjs.__require.call(void 0, "@noble/hashes/sha256");
      return sha256(data);
    }
