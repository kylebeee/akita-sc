...
function resolveAppId(providedAppId, envVarName, sdkName = "SDK", network) {
  ...
  const targetNetwork = _nullishCoalesce(network, () => ( getCurrentNetwork()));
...
var emptySigner = _algosdk.makeEmptyTransactionSigner.call(void 0, );
