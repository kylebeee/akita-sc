...
import { HyperSwapArgs } from '../generated/HyperSwapClient';
type ContractArgs = HyperSwapArgs["obj"];
export type OfferParams = MaybeSigner & Omit<ContractArgs['offer(pay,byte[32],uint64,byte[32],uint64,uint64)void'], 'payment'>;
export type AcceptParams = MaybeSigner & Omit<ContractArgs['accept(pay,uint64,byte[32][])void'], 'mbrPayment'>;
...
export type OptInParams = MaybeSigner & Omit<ContractArgs['optIn(pay,uint64)void'], 'payment'>;
