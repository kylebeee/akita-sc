...
exports.RewardsPluginClient = exports.RewardsPluginFactory = exports.RewardsPluginParamsFactory = exports.APP_SPEC = void 0;
 ...
 */
class RewardsPluginParamsFactory {
    /**
...
exports.RewardsPluginParamsFactory = RewardsPluginParamsFactory;
/**
...
class RewardsPluginFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? RewardsPluginParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
        return { result: result.result, appClient: new RewardsPluginClient(result.appClient) };
    }
}
exports.RewardsPluginFactory = RewardsPluginFactory;
/**
...
class RewardsPluginClient {
    ...
    static async fromCreatorAndName(params) {
        return new RewardsPluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new RewardsPluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.RewardsPluginClient = RewardsPluginClient;
//# sourceMappingURL=RewardsPluginClient.js.map