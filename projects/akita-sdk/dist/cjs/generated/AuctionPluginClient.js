...
exports.AuctionPluginClient = exports.AuctionPluginFactory = exports.AuctionPluginParamsFactory = exports.APP_SPEC = void 0;
 ...
 */
class AuctionPluginParamsFactory {
    /**
...
exports.AuctionPluginParamsFactory = AuctionPluginParamsFactory;
/**
...
class AuctionPluginFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? AuctionPluginParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
            deleteParams: params.deleteParams?.method ? AuctionPluginParamsFactory.delete._resolveByMethod(params.deleteParams) : params.deleteParams ? params.deleteParams : undefined,
        });
        return { result: result.result, appClient: new AuctionPluginClient(result.appClient) };
    }
}
exports.AuctionPluginFactory = AuctionPluginFactory;
/**
...
class AuctionPluginClient {
    ...
    static async fromCreatorAndName(params) {
        return new AuctionPluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new AuctionPluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.AuctionPluginClient = AuctionPluginClient;
//# sourceMappingURL=AuctionPluginClient.js.map