 ...
 */
export type MockMarketplaceCreateCallParams = Expand<AppClientBareCallParams & {
    method?: never;
} & {
 ...
 */
export type MockMarketplaceDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
    /**
     * Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)
     */
    createParams?: MockMarketplaceCreateCallParams;
}>;
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the MockMarketplace smart contract
 */
export declare abstract class MockMarketplaceParamsFactory {
    /**
 ...
 */
export declare class MockMarketplaceFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): MockMarketplaceClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<MockMarketplaceClient>;
    /**
     ...
     */
    deploy(params?: MockMarketplaceDeployParams): Promise<{
        result: {
        ...
        appClient: MockMarketplaceClient;
    }>;
    /**
 ...
 */
export declare class MockMarketplaceClient {
    /**
     ...
     */
    decodeReturnValue<TSignature extends MockMarketplaceNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined): MethodReturn<TSignature> | undefined;
    /**
     * Returns a new `MockMarketplaceClient` client, resolving the app by creator address and name
     * using AlgoKit app deployment semantics (i.e. looking for the app creation transaction note).
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<MockMarketplaceClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<MockMarketplaceClient>;
    ...
    readonly params: {
         ...
         */
        ping: (params?: CallParams<MockMarketplaceArgs["obj"]["ping()uint64"] | MockMarketplaceArgs["tuple"]["ping()uint64"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
    ...
    readonly send: {
         ...
         */
        ping: (params?: CallParams<MockMarketplaceArgs["obj"]["ping()uint64"] | MockMarketplaceArgs["tuple"]["ping()uint64"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | MockMarketplaceReturns["ping()uint64"]);
            groupId: string;
            txIds: string[];
     ...
     */
    clone(params: CloneAppClientParams): MockMarketplaceClient;
    /**
     * Methods to access state for the current MockMarketplace app
     */
    state: {};
    newGroup(): MockMarketplaceComposer;
}
export type MockMarketplaceComposer<TReturns extends [...any[]] = []> = {
     ...
     */
    simulate(): Promise<MockMarketplaceComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<MockMarketplaceComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<MockMarketplaceComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    /**
