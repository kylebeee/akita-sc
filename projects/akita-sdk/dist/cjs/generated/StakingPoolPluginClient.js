...
exports.StakingPoolPluginClient = exports.StakingPoolPluginFactory = exports.StakingPoolPluginParamsFactory = exports.APP_SPEC = void 0;
exports.RootKeyFromTuple = RootKeyFromTuple;
exports.RaffleCursorFromTuple = RaffleCursorFromTuple;
exports.RewardFromTuple = RewardFromTuple;
 ...
 */
function RaffleCursorFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.RaffleCursor, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a Reward to the struct representation
 */
function RewardFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.Reward, exports.APP_SPEC.structs);
}
/**
 ...
 */
class StakingPoolPluginParamsFactory {
    /**
...
exports.StakingPoolPluginParamsFactory = StakingPoolPluginParamsFactory;
/**
 ...
 */
class StakingPoolPluginFactory {
    /**
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? StakingPoolPluginParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
        return { result: result.result, appClient: new StakingPoolPluginClient(result.appClient) };
    }
}
exports.StakingPoolPluginFactory = StakingPoolPluginFactory;
/**
...
class StakingPoolPluginClient {
    constructor(appClientOrParams) {
        ...
        this.state = {
            ...
            global: {
                 ...
                 */
                factory: async () => { return (await this.appClient.state.global.getValue("factory")); },
                /**
    ...
    static async fromCreatorAndName(params) {
        return new StakingPoolPluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new StakingPoolPluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.StakingPoolPluginClient = StakingPoolPluginClient;
//# sourceMappingURL=StakingPoolPluginClient.js.map