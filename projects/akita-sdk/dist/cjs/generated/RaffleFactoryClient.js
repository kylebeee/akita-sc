...
exports.RaffleFactoryClient = exports.RaffleFactoryFactory = exports.RaffleFactoryParamsFactory = exports.APP_SPEC = void 0;
exports.RaffleMbrDataFromTuple = RaffleMbrDataFromTuple;
 ...
 */
function RaffleMbrDataFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.RaffleMBRData, exports.APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the RaffleFactory smart contract
 */
class RaffleFactoryParamsFactory {
    /**
...
exports.RaffleFactoryParamsFactory = RaffleFactoryParamsFactory;
/**
...
class RaffleFactoryFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? RaffleFactoryParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
            updateParams: params.updateParams?.method ? RaffleFactoryParamsFactory.update._resolveByMethod(params.updateParams) : params.updateParams ? params.updateParams : undefined,
        });
        return { result: result.result, appClient: new RaffleFactoryClient(result.appClient) };
    }
}
exports.RaffleFactoryFactory = RaffleFactoryFactory;
/**
...
class RaffleFactoryClient {
    ...
    static async fromCreatorAndName(params) {
        return new RaffleFactoryClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new RaffleFactoryClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.RaffleFactoryClient = RaffleFactoryClient;
//# sourceMappingURL=RaffleFactoryClient.js.map