...
exports.NfdGateClient = exports.NfdGateFactory = exports.NfdGateParamsFactory = exports.APP_SPEC = void 0;
...
exports.NfdGateParamsFactory = NfdGateParamsFactory;
/**
...
exports.NfdGateFactory = NfdGateFactory;
/**
...
class NfdGateClient {
    ...
    static async fromCreatorAndName(params) {
        return new NfdGateClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new NfdGateClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.NfdGateClient = NfdGateClient;
