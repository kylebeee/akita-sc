...
exports.PaySiloPluginClient = exports.PaySiloPluginFactory = exports.PaySiloPluginParamsFactory = exports.APP_SPEC = void 0;
 ...
 */
class PaySiloPluginParamsFactory {
    /**
...
exports.PaySiloPluginParamsFactory = PaySiloPluginParamsFactory;
/**
...
class PaySiloPluginFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? PaySiloPluginParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
        return { result: result.result, appClient: new PaySiloPluginClient(result.appClient) };
    }
}
exports.PaySiloPluginFactory = PaySiloPluginFactory;
/**
...
class PaySiloPluginClient {
    constructor(appClientOrParams) {
        ...
        this.state = {
            ...
            global: {
                 ...
                 */
                recipient: async () => { return (await this.appClient.state.global.getValue("recipient")); },
            },
        };
    ...
    static async fromCreatorAndName(params) {
        return new PaySiloPluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new PaySiloPluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.PaySiloPluginClient = PaySiloPluginClient;
//# sourceMappingURL=PaySiloPluginClient.js.map