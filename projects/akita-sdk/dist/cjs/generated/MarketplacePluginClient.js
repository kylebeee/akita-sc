...
exports.MarketplacePluginClient = exports.MarketplacePluginFactory = exports.MarketplacePluginParamsFactory = exports.APP_SPEC = void 0;
 ...
 */
class MarketplacePluginParamsFactory {
    /**
...
exports.MarketplacePluginParamsFactory = MarketplacePluginParamsFactory;
/**
...
class MarketplacePluginFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? MarketplacePluginParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
        return { result: result.result, appClient: new MarketplacePluginClient(result.appClient) };
    }
}
exports.MarketplacePluginFactory = MarketplacePluginFactory;
/**
...
class MarketplacePluginClient {
    ...
    static async fromCreatorAndName(params) {
        return new MarketplacePluginClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new MarketplacePluginClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.MarketplacePluginClient = MarketplacePluginClient;
//# sourceMappingURL=MarketplacePluginClient.js.map