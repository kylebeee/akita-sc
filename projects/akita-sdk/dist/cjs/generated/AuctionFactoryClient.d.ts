 ...
 */
export type AuctionFactoryCreateCallParams = Expand<CallParams<AuctionFactoryArgs['obj']['create(string,string,uint64,uint64)void'] | AuctionFactoryArgs['tuple']['create(string,string,uint64,uint64)void']> & {
    method: 'create';
} & {
    onComplete?: OnApplicationComplete.NoOpOC;
} & CreateSchema> | Expand<CallParams<AuctionFactoryArgs['obj']['create(string,string,uint64,uint64)void'] | AuctionFactoryArgs['tuple']['create(string,string,uint64,uint64)void']> & {
...
export declare abstract class AuctionFactoryParamsFactory {
    ...
    static get create(): {
         ...
         */
        create(params: CallParams<AuctionFactoryArgs["obj"]["create(string,string,uint64,uint64)void"] | AuctionFactoryArgs["tuple"]["create(string,string,uint64,uint64)void"]> & AppClientCompilationParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
...
export declare class AuctionFactoryFactory {
    ...
    readonly params: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<AuctionFactoryArgs["obj"]["create(string,string,uint64,uint64)void"] | AuctionFactoryArgs["tuple"]["create(string,string,uint64,uint64)void"]> & AppClientCompilationParams & CreateSchema & {
                onComplete?: OnApplicationComplete.NoOpOC;
            }) => Promise<{
    ...
    readonly send: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<AuctionFactoryArgs["obj"]["create(string,string,uint64,uint64)void"] | AuctionFactoryArgs["tuple"]["create(string,string,uint64,uint64)void"]> & AppClientCompilationParams & CreateSchema & SendParams & {
                onComplete?: OnApplicationComplete.NoOpOC;
            }) => Promise<{
                result: {
                    return: (undefined | AuctionFactoryReturns["create(string,string,uint64,uint64)void"]);
                    compiledApproval?: import("@algorandfoundation/algokit-utils/types/app").CompiledTeal | undefined;
                    compiledClear?: import("@algorandfoundation/algokit-utils/types/app").CompiledTeal | undefined;
                    appId: bigint;
                    groupId: string;
...
export declare class AuctionFactoryClient {
     ...
     */
    decodeReturnValue<TSignature extends AuctionFactoryNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined): MethodReturn<TSignature> | undefined;
    /**
    ...
    readonly params: {
        ...
        update: {
             ...
             */
            update: (params: CallParams<AuctionFactoryArgs["obj"]["update(string)void"] | AuctionFactoryArgs["tuple"]["update(string)void"]> & AppClientCompilationParams) => Promise<{
                approvalProgram: Uint8Array;
                clearStateProgram: Uint8Array;
                compiledApproval?: import("@algorandfoundation/algokit-utils/types/app").CompiledTeal | undefined;
                compiledClear?: import("@algorandfoundation/algokit-utils/types/app").CompiledTeal | undefined;
         ...
         * @returns The call params
         */
        updateAkitaDaoEscrow: (params: CallParams<AuctionFactoryArgs["obj"]["updateAkitaDAOEscrow(uint64)void"] | AuctionFactoryArgs["tuple"]["updateAkitaDAOEscrow(uint64)void"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<AppCallMethodCall>;
        /**
    ...
    readonly send: {
        ...
        update: {
             ...
             */
            update: (params: CallParams<AuctionFactoryArgs["obj"]["update(string)void"] | AuctionFactoryArgs["tuple"]["update(string)void"]> & AppClientCompilationParams & SendParams) => Promise<{
         ...
         * @returns The call result
         */
        updateAkitaDaoEscrow: (params: CallParams<AuctionFactoryArgs["obj"]["updateAkitaDAOEscrow(uint64)void"] | AuctionFactoryArgs["tuple"]["updateAkitaDAOEscrow(uint64)void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | AuctionFactoryReturns["updateAkitaDAOEscrow(uint64)void"]);
            groupId: string;
            txIds: string[];
            returns?: ABIReturn[] | undefined | undefined;
            confirmations: modelsv2.PendingTransactionResponse[];
    ...
    newGroup(): AuctionFactoryComposer;
}
