...
exports.MetaMerklesClient = exports.MetaMerklesFactory = exports.MetaMerklesParamsFactory = exports.APP_SPEC = void 0;
exports.DataKeyFromTuple = DataKeyFromTuple;
exports.RootKeyFromTuple = RootKeyFromTuple;
exports.TypesValueFromTuple = TypesValueFromTuple;
 ...
 */
function DataKeyFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.DataKey, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a RootKey to the struct representation
 */
function RootKeyFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.RootKey, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a TypesValue to the struct representation
 */
function TypesValueFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.TypesValue, exports.APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the MetaMerkles smart contract
 */
class MetaMerklesParamsFactory {
    /**
...
exports.MetaMerklesParamsFactory = MetaMerklesParamsFactory;
/**
...
class MetaMerklesFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? MetaMerklesParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
        return { result: result.result, appClient: new MetaMerklesClient(result.appClient) };
    }
}
exports.MetaMerklesFactory = MetaMerklesFactory;
/**
...
class MetaMerklesClient {
    constructor(appClientOrParams) {
        ...
        this.state = {
            ...
            global: {
                 ...
                 */
                typesId: async () => { return (await this.appClient.state.global.getValue("typesID")); },
            },
            /**
            ...
            box: {
                ...
                types: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("types")); },
                    /**
                     * Get a current value of the types map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("types", key); },
                },
                /**
                ...
                roots: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("roots")); },
                    /**
                     * Get a current value of the roots map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("roots", key); },
                },
                /**
                ...
                data: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("data")); },
                    /**
                     * Get a current value of the data map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("data", key); },
                },
            },
        };
    ...
    static async fromCreatorAndName(params) {
        return new MetaMerklesClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new MetaMerklesClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.MetaMerklesClient = MetaMerklesClient;
//# sourceMappingURL=MetaMerklesClient.js.map