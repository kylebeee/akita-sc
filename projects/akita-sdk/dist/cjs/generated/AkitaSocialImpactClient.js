...
exports.AkitaSocialImpactClient = exports.AkitaSocialImpactFactory = exports.AkitaSocialImpactParamsFactory = exports.APP_SPEC = void 0;
exports.Arc4ImpactMetaValueFromTuple = Arc4ImpactMetaValueFromTuple;
exports.MetaValueFromTuple = MetaValueFromTuple;
 ...
 */
function Arc4ImpactMetaValueFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.arc4ImpactMetaValue, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a MetaValue to the struct representation
 */
function MetaValueFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.MetaValue, exports.APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the AkitaSocialImpact smart contract
 */
class AkitaSocialImpactParamsFactory {
    /**
...
exports.AkitaSocialImpactParamsFactory = AkitaSocialImpactParamsFactory;
/**
 ...
 */
class AkitaSocialImpactFactory {
    /**
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? AkitaSocialImpactParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
            updateParams: params.updateParams?.method ? AkitaSocialImpactParamsFactory.update._resolveByMethod(params.updateParams) : params.updateParams ? params.updateParams : undefined,
        });
        return { result: result.result, appClient: new AkitaSocialImpactClient(result.appClient) };
    }
}
exports.AkitaSocialImpactFactory = AkitaSocialImpactFactory;
/**
...
class AkitaSocialImpactClient {
        ...
        this.state = {
            ...
            box: {
                ...
                meta: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("meta")); },
                    /**
                     * Get a current value of the meta map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("meta", key); },
                },
                /**
                ...
                subscriptionStateModifier: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("subscriptionStateModifier")); },
                    /**
                     * Get a current value of the subscriptionStateModifier map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("subscriptionStateModifier", key); },
                },
            },
        };
    ...
    static async fromCreatorAndName(params) {
        return new AkitaSocialImpactClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new AkitaSocialImpactClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
...
exports.AkitaSocialImpactClient = AkitaSocialImpactClient;
//# sourceMappingURL=AkitaSocialImpactClient.js.map