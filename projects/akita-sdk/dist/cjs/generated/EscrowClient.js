...
exports.EscrowClient = exports.EscrowFactory = exports.EscrowParamsFactory = exports.APP_SPEC = void 0;
...
exports.EscrowParamsFactory = EscrowParamsFactory;
/**
...
class EscrowClient {
    ...
    static async fromCreatorAndName(params) {
        return new EscrowClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new EscrowClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
