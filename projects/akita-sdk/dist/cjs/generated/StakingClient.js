...
exports.StakingClient = exports.StakingFactory = exports.StakingParamsFactory = exports.APP_SPEC = void 0;
exports.EscrowFromTuple = EscrowFromTuple;
exports.HeartbeatKeyFromTuple = HeartbeatKeyFromTuple;
exports.StakeFromTuple = StakeFromTuple;
exports.StakeCheckFromTuple = StakeCheckFromTuple;
exports.StakeInfoFromTuple = StakeInfoFromTuple;
exports.StakeKeyFromTuple = StakeKeyFromTuple;
exports.TotalsInfoFromTuple = TotalsInfoFromTuple;
 ...
 */
function EscrowFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.Escrow, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a HeartbeatKey to the struct representation
 */
function HeartbeatKeyFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.HeartbeatKey, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a Stake to the struct representation
 */
function StakeFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.Stake, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a StakeCheck to the struct representation
 */
function StakeCheckFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.StakeCheck, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a StakeInfo to the struct representation
 */
function StakeInfoFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.StakeInfo, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a StakeKey to the struct representation
 */
function StakeKeyFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.StakeKey, exports.APP_SPEC.structs);
}
/**
 * Converts the ABI tuple representation of a TotalsInfo to the struct representation
 */
function TotalsInfoFromTuple(abiTuple) {
    return (0, app_arc56_1.getABIStructFromABITuple)(abiTuple, exports.APP_SPEC.structs.TotalsInfo, exports.APP_SPEC.structs);
}
/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the Staking smart contract
 */
class StakingParamsFactory {
    /**
...
exports.StakingParamsFactory = StakingParamsFactory;
/**
...
class StakingFactory {
    ...
    async deploy(params = {}) {
        const result = await this.appFactory.deploy({
            ...params,
            createParams: params.createParams?.method ? StakingParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams : undefined,
        });
...
class StakingClient {
    constructor(appClientOrParams) {
        ...
        this.state = {
            ...
            global: {
                 ...
                 */
                heartbeatManagerAddress: async () => { return (await this.appClient.state.global.getValue("heartbeatManagerAddress")); },
                /**
            ...
            box: {
                ...
                stakes: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("stakes")); },
                    /**
                     * Get a current value of the stakes map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("stakes", key); },
                },
                /**
                ...
                heartbeats: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("heartbeats")); },
                    /**
                     * Get a current value of the heartbeats map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("heartbeats", key); },
                },
                /**
                ...
                totals: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("totals")); },
                    /**
                     * Get a current value of the totals map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("totals", key); },
                },
                /**
                ...
                settings: {
                     ...
                     */
                    getMap: async () => { return (await this.appClient.state.box.getMap("settings")); },
                    /**
                     * Get a current value of the settings map by key from box state
                     */
                    value: async (key) => { return await this.appClient.state.box.getMapValue("settings", key); },
                },
            },
        };
    ...
    static async fromCreatorAndName(params) {
        return new StakingClient(await app_client_1.AppClient.fromCreatorAndName({ ...params, appSpec: exports.APP_SPEC }));
    }
    /**
    ...
    static async fromNetwork(params) {
        return new StakingClient(await app_client_1.AppClient.fromNetwork({ ...params, appSpec: exports.APP_SPEC }));
    }
