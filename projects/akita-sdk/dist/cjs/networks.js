...
exports.ENV_TO_NETWORK_KEY = exports.NETWORK_APP_IDS = exports.MAINNET_APP_IDS = exports.TESTNET_APP_IDS = exports.LOCALNET_APP_IDS = void 0;
exports.getNetworkAppIds = getNetworkAppIds;
exports.getAppIdFromNetwork = getAppIdFromNetwork;
/**
 * Localnet app IDs
 *
 ...
 *
 * Last updated: 2026-02-08T20:14:09.165Z
 */
exports.LOCALNET_APP_IDS = {
    ...
    assetGate: 1052n,
    merkleAddressGate: 1057n,
    merkleAssetGate: 1053n,
    nfdGate: 1054n,
    nfdRootGate: 1056n,
    pollGate: 1055n,
    socialActivityGate: 1060n,
    socialFollowerCountGate: 1061n,
    socialFollowerIndexGate: 1062n,
    socialImpactGate: 1058n,
    socialModeratorGate: 1063n,
    stakingAmountGate: 1059n,
    stakingPowerGate: 1064n,
    subscriptionGate: 1065n,
    subscriptionStreakGate: 1066n,
    // Assets
    akta: 1002n,
    bones: 1631n,
    usdc: 1003n,
 ...
 */
exports.NETWORK_APP_IDS = {
    localnet: exports.LOCALNET_APP_IDS,
    testnet: exports.TESTNET_APP_IDS,
    mainnet: exports.MAINNET_APP_IDS,
};
/**
...
function getNetworkAppIds(network) {
    return exports.NETWORK_APP_IDS[network];
}
/**
 * Mapping from SDK/env var names to NetworkAppIds keys
 */
exports.ENV_TO_NETWORK_KEY = {
    DAO_APP_ID: 'dao',
...
function getAppIdFromNetwork(network, envVarName) {
    ...
    const key = exports.ENV_TO_NETWORK_KEY[envVarName];
    if (!key)
        return undefined;
