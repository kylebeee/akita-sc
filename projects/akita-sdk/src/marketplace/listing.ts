 ...
 */
export class ListingSDK extends BaseSDK<ListingClient> {
   ...
   */
  async state(): Promise<ListingState> {
   ...
   */
  async changePrice({ sender, signer, price }: ChangePriceParams): Promise<void> {
